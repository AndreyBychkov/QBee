...
from .substitution_heuristics import get_heuristic_sorter
...
def quadratize(system: PolynomialSystem, search_algorithm: str = "ID-DLS", auxiliary_eq_type: str = "differential", heuristics: str = "default",
...
def _bfs(system: PolynomialSystem, auxiliary_eq_type: str, heuristics: str, initial_max_depth: int, limit_depth: int, disable_pbar: bool,
...
def _iddls(system: PolynomialSystem, auxiliary_eq_type: str, heuristics: str, initial_max_depth: int, limit_depth: int, disable_pbar: bool,
           log_rows_list: Optional[List]) -> QuadratizationResult:
    processed_systems_pbar = tqdm(unit="node", desc="Systems processed: ", position=0, disable=disable_pbar)
...
def _make_new_system(system: PolynomialSystem, auxiliary_eq_type, substitution) -> PolynomialSystem:
