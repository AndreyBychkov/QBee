...
def ql_iddfs_1_stat(_) -> int:
    ql_system = quadratic_linearize(system, mode="optimal", heuristics='default', method_optimal="iddfs", initial_max_depth=1)
    return ql_system.statistics.steps


def ql_iddfs_2_stat(_) -> int:
    ql_system = quadratic_linearize(system, mode="optimal", heuristics='default', method_optimal="iddfs", initial_max_depth=2)
    return ql_system.statistics.steps
