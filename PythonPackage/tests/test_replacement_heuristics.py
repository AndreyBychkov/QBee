...
from replacement_heuristics import _compute_monomials_affected, _compute_replacement_value_for_all_monomials
...
def test_compute_replacement_value_for_all_monomials():
    ...
    assert _compute_replacement_value_for_all_monomials(system, replacement) == 6
